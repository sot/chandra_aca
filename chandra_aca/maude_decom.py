...
ACA_PACKETS_DTYPE = np.dtype(
    [('TIME', np.float64), ('VCDUCTR', np.uint32), ('MJF', np.uint32), ('MNF', np.uint32),
     ...
     ('BGDSTAT', np.uint8), ('HIGH_BGD', bool), ('RAM_FAIL', bool),
     ('ROM_FAIL', bool), ('POWER_FAIL', bool), ('CAL_FAIL', bool),
     ('COMM_CHECKSUM_FAIL', bool), ('RESET', bool), ('SYNTAX_ERROR', bool),
     ('COMMCNT_SYNTAX_ERROR', bool), ('COMMCNT_CHECKSUM_FAIL', bool),
     ('COMMPROG_REPEAT', np.uint8), ('IMGFID', bool),
     ('IMGSTAT', np.uint8), ('SAT_PIXEL', bool), ('DEF_PIXEL', bool),
     ('QUAD_BOUND', bool), ('COMMON_COL', bool), ('MULTI_STAR', bool),
     ('ION_RAD', bool), ('IMGROW_A1', np.int16), ('IMGCOL_A1', np.int16),
