...
ACA_PACKETS_DTYPE = np.dtype(
    [('TIME', np.float64), ('VCDUCTR', np.uint32), ('MJF', np.uint32), ('MNF', np.uint32),
     ...
     ('BGDSTAT', np.uint8), ('HIGH_BGD', np.bool_), ('RAM_FAIL', np.bool_),
     ('ROM_FAIL', np.bool_), ('POWER_FAIL', np.bool_), ('CAL_FAIL', np.bool_),
     ('COMM_CHECKSUM_FAIL', np.bool_), ('RESET', np.bool_), ('SYNTAX_ERROR', np.bool_),
     ('COMMCNT_SYNTAX_ERROR', np.bool_), ('COMMCNT_CHECKSUM_FAIL', np.bool_),
     ('COMMPROG_REPEAT', np.uint8), ('IMGFID', np.bool_),
     ('IMGSTAT', np.uint8), ('SAT_PIXEL', np.bool_), ('DEF_PIXEL', np.bool_),
     ('QUAD_BOUND', np.bool_), ('COMMON_COL', np.bool_), ('MULTI_STAR', np.bool_),
     ('ION_RAD', np.bool_), ('IMGROW_A1', np.int16), ('IMGCOL_A1', np.int16),
