...
@pytest.mark.skipif('not HAS_L1_ARCHIVE',
                    reason='No ground solutions without an aspl1 mica archive')
@pytest.mark.skipif('not HAS_STARCHECK_ARCHIVE',
...
@pytest.mark.skipif('not HAS_STARCHECK_ARCHIVE',
                    reason='No for_slot without a starcheck mica archive')
@pytest.mark.skipif('not HAS_QUAT_TELEM', reason='No AOATTQT* telemetry in Ska.engarchive')
def test_obc():
